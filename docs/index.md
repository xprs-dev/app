...
| [f-droid.md](f-droid.md) | XPRS on F-Droid: the submission thread and how to follow it, the recipe, releasing through F-Droid, and the APK audit (`tool/fdroid_scan.py`). |
